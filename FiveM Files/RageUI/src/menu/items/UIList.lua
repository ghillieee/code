    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                local ListText = (type(Items[currentIndex]) == "table") and string.format("← %s →", Items[currentIndex].Name) or string.format("← %s →", Items[currentIndex]) or "NIL"
                ...
                if (Enabled) then
                    Callback(Hovered, Selected, ((CurrentMenu.Controls.Select.Active or ((Hovered and CurrentMenu.Controls.Click.Active) and (not LeftArrowHovered and not RightArrowHovered))) and Selected), Index, currentIndex)
                end
            end
